...
\twocol{0.7}{0.3}{
\includegraphics[width=\textwidth]{2-2_conditional_probability/figures/cancer_tree/cancer_tree_first} 
}
{
\pause
{\footnotesize
...
{
\solnGr{\only<2->{
\includegraphics[width=\textwidth]{2-2_conditional_probability/figures/cancer_tree/cancer_tree_second} 
}}
}
...
\includegraphics[width=\textwidth]{2-2_conditional_probability/figures/sir_tree/sir_tree} 
