...
\begin{figure}
\includegraphics[width=0.7\textwidth]{2-1_define_probability/figures/cards}
\end{figure}
...
\{ \sout{\textcolor{gray}{M}}, \red{F} \} $\rightarrow$ Boy and girl are \hl{complementary} outcomes.
...
\soln{\pause{\{ \red{MM}, \sout{\textcolor{gray}{FF}}, \red{FM}, \red{MF} \} }}
\end{itemize}
...
{
\includegraphics[width=0.9\textwidth]{2-1_define_probability/figures/uninsured}
}
