...
\twocol{0.5}{0.5}{
\includegraphics[width=1.1\textwidth]{7-1_one_t/figures/friday/fridayPvalue}
}
{
$T = 4.94$
...
\twocol{0.5}{0.5}{
\only<1-3>{\includegraphics[width=\textwidth]{7-1_one_t/figures/middle95/middle95_1}}
\only<4| handout:0>{\includegraphics[width=\textwidth]{7-1_one_t/figures/middle95/middle95_2}}
}
{
