...
\item \hl{Parameter of interest:} Proportion of \red{all} Americans who have good intuition about experimental design.
\[ \mathhl{p}~\scriptsize{(\text{a population proportion})} \]

\pause

\item \hl{Point estimate:} Proportion of \red{sampled} Americans who have good intuition about experimental design.
...
\begin{enumerate}[(a)]
\solnMult{$0.85 \pm 1.96 \times \sqrt{\frac{0.85 \times 0.15}{670}}$} \soln{\only<2>{\red{$\rightarrow (0.82, 0.88)$}}}
