...
\only<1>{
\begin{center}
\includegraphics[width=0.8\textwidth]{4-4_binomial_distribution/figures/homeschool}
\end{center}
}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{4-4_binomial_distribution/figures/fourBinomialModelsShowingApproxToNormal/fourBinomialModelsShowingApproxToNormal}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{4-4_binomial_distribution/figures/fb_power_user/fb_power_user}
\end{center}
...
\twocol{0.5}{0.5}{
\begin{center}
\includegraphics[width=\textwidth]{4-4_binomial_distribution/figures/fb_power_user/fb_power_user_norm}
\end{center}
}
{
\pause
