...
\item The CLT, which states that sampling distributions will be nearly normal, holds true for \red{any} sample size as long as the population distribution is nearly normal.
...
\begin{center}
\includegraphics[width=0.8\textwidth]{5-3_one_t/figures/tDistConvergeToNormalDist/tDistConvergeToNormalDist}
\end{center}
...
\hspace{8.5cm} \red{$\downarrow$}
\begin{align*}
\hspace{6cm} &\red{$\bar{x}_{diff} = 1836$} \\
& \red{$s_{diff} = 1176$} \\
& \red{$n = 10$} 
\end{align*}
...
\item Or when these aren't available, we can use a \webLink{http://www.openintro.org/stat/down/probTables.pdf}{$t$ table}.
...
one tail & \hspace{1.5mm}  0.100 & \hspace{1.5mm} 0.050 & \hspace{1.5mm} 0.025 & \hspace{1.5mm} 0.010 & \hspace{1.5mm} 0.005  \\
  \rowcolor[gray]{.6}
two tails & 0.200 & 0.100 & 0.050 & 0.020 & \red{0.010} & \mathhl{\rightarrow} \\
\hline
{df} \hfill 6  &  {  1.44} & {  1.94} & {  2.45} & {  3.14} & {  3.71}  \\ 
7  &  {  1.41} & {  1.89} & {  2.36} & {  3.00} & {  3.50}  \\ 
8  &  {  1.40} & {  1.86} & {  2.31} & {  2.90} & {  3.36}  \\ 
  \rowcolor[gray]{.6}
9  &  {  1.38} & {  1.83} & {  2.26} & {  2.82} & \red{  3.25} & \mathhl{\rightarrow}  \\ 
10  &  {  1.37} & {  1.81} & {  2.23} & {  2.76} & {  3.17}  \\ 
\end{tabular}
\end{center}
}
...
\twocol{0.5}{0.5}{
\includegraphics[width=1.1\textwidth]{5-3_one_t/figures/friday/fridayPvalue}
}
{
$T = 4.94$
...
\twocol{0.5}{0.5}{
\only<1-3>{\includegraphics[width=\textwidth]{5-3_one_t/figures/middle95/middle95_1}}
\only<4| handout:0>{\includegraphics[width=\textwidth]{5-3_one_t/figures/middle95/middle95_2}}
}
{
...
\hline
one tail & \hspace{1.5mm}  0.100 & \hspace{1.5mm} 0.050 & \hspace{1.5mm} 0.025 & \hspace{1.5mm} 0.010 & \hspace{1.5mm} 0.005  \\
two tails & 0.200 & 0.100 & \red{0.050} & 0.020 & {0.010} \\
\hline
{df} \hfill 6  &  {  1.44} & {  1.94} & {  2.45} & {  3.14} & {  3.71}  \\ 
7  &  {  1.41} & {  1.89} & {  2.36} & {  3.00} & {  3.50}  \\ 
8  &  {  1.40} & {  1.86} & {  2.31} & {  2.90} & {  3.36}  \\ 
...
8  &  {  1.40} & {  1.86} & {  2.31} & {  2.90} & {  3.36}  \\ 
  \rowcolor[gray]{.6}
9  &  {  1.38} & {  1.83} & \red{  2.26} & {  2.82} & {  3.25} \\ 
10  &  {  1.37} & {  1.81} & {  2.23} & {  2.76} & {  3.17}  \\ 
\end{tabular}
\end{center}
}}
...
{
\soln{\only<2>{\red{$\rightarrow$ (995, 2677)}}}
\vspace{0.25cm}
}
...
\pq{Which of the following is the \red{best} interpretation for the confidence interval we just calculated?
