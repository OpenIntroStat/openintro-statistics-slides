...
\begin{center}
\includegraphics[width=0.8\textwidth]{5-4_clt/figures/duke_games/duke_games_pop}
\end{center}
...
\twocol{0.6}{0.4}{
\begin{center}
\includegraphics[width=\textwidth]{5-4_clt/figures/duke_games/duke_games_n10}
\end{center}
}
{
...
\twocol{0.6}{0.4}{
\begin{center}
\includegraphics[width=\textwidth]{5-4_clt/figures/duke_games/duke_games_n30}
\end{center}
}
{
...
\begin{center}
\includegraphics[width=0.6\textwidth]{5-4_clt/figures/duke_games/duke_games_n70}
\end{center}
...
\twocol{0.4}{0.6}{
\includegraphics[width=\textwidth]{5-4_clt/figures/cltSimRS/cltSimRS_pop}
}
{
\vspace{-0.5cm}
{\small
...
\vspace{-0.25cm}
\includegraphics[width=0.32\textwidth]{5-4_clt/figures/cltSimRS/cltSimRS_n7}
\includegraphics[width=0.32\textwidth]{5-4_clt/figures/cltSimRS/cltSimRS_samp}
\includegraphics[width=0.32\textwidth]{5-4_clt/figures/cltSimRS/cltSimRS_n49}
