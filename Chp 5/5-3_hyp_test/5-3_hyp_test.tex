...
\begin{center}
\includegraphics[width=0.75\textwidth]{5-3_hyp_test/figures/discRandDotPlot/discRandDotPlot}
\end{center}
...
\twocol{0.55}{0.45}{
\begin{center}
\includegraphics[width=\textwidth]{5-3_hyp_test/figures/app/app_z}
\end{center}
\pause
...
\pause
\item The difference between the null value of 8 schools and observed sample mean of 9.7 schools is \orange{not due to chance} or sampling variability.
