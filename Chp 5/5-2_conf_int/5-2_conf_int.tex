...
\includegraphics[width=\textwidth]{5-2_conf_int/figures/spear}
\column{0.5\textwidth}
{\small
We can throw a spear where we saw a fish but we will probably miss. If we toss a net in that area, we have a good chance of catching the fish.
}
\column{0.25\textwidth}
\includegraphics[width=\textwidth]{5-2_conf_int/figures/net}
\end{columns}
$\:$ \\
...
\begin{center}
\includegraphics[width=0.9\textwidth]{5-2_conf_int/figures/garfield}
\end{center}
...
\soln{\only<2>{
\begin{center}
\includegraphics[width=0.7\textwidth]{5-2_conf_int/figures/middle98/middle98}
\end{center}
}}
