...
\begin{center}
\includegraphics[width=0.5\textwidth]{5-1_paired/figures/hsb2/hsb2_read_write_box}
\end{center}
...
{
\includegraphics[width=\textwidth]{5-1_paired/figures/hsb2/hsb2_diff_hist}
}
...
\item \hl{Parameter of interest:} Average difference between the reading and writing scores of \red{all} high school students.
\[ \mu_{diff} \]
...
\item \hl{Point estimate:} Average difference between the reading and writing scores of \red{sampled} high school students.
\[ \bar{x}_{diff} \]
...
\item We have data from \red{one} sample: differences. 
...
\soln{\pause
\begin{eqnarray*} 
-0.545 \pm 1.96 \frac{8.887}{\sqrt{200}} &=& -0.545 \pm 1.96 \times 0.628 \\
&=& -0.545 \pm 1.23 \\
&=& (-1.775, 0.685)
\end{eqnarray*}
}
